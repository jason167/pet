...
public class Stat extends Table {
	public static Stat getRootAsStat(ByteBuffer _bb) {
		return getRootAsStat(_bb, new Stat());
	}
	...
	public Stat __init(int _i, ByteBuffer _bb) {
		bb_pos = _i;
		bb = _bb;
		return this;
	}
	...
	public static int createStat(FlatBufferBuilder builder, int id, long val,
			long count) {
